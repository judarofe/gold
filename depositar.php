...
<head>
    ...
    <title>DEPOSITAR | GOLD CAPITAL COMPANY</title>
...
<header>
    <nav class="navbar navbar-expand-lg">
        <div class="container">
            <a class="navbar-brand" href="index.php">GOLD CAPITAL COMPANY</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 navbar-centrado">
                    <li class="nav-item">
                        <a class="nav-link" aria-current="depositar.php" href="#">Depósitos</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="planes.php">Retiros</a>
                    </li>
                    <li class="nav-item">
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><button type="button" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#login">Iniciar sesión</button></li>
                            <li><button type="button" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#Registro">Comenzar</button></li>
                        </ul>
                    </li>
                </ul>
            </div>
                        ...
                        <div class="bodyModal">
                            <div class="input-group mb-3">
                                ...
                                <div class="form-floating">
                                    <input type="email" class="form-control" id="floatingInputGroup1" placeholder="Email ID">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control inputRegistro" id="floatingInputNombre" placeholder="Nombre">
                            <label for="floatingInputNombre">Nombre</label>
                        </div>
                    </div>
                    <div class="col">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control inputRegistro" id="floatingInputApellido" placeholder="Apellido">
                ...
                <div class="row">
                    <div class="col">
                        <div class="form-floating mb-3">
                            <input type="email" class="form-control inputRegistro" id="floatingInputemail" placeholder="Correo electrónico">
                ...
                <div class="row">
                    <div class="col">
                        <div class="form-floating mb-3">
                            <input type="password" class="form-control inputRegistro" id="floatingInputpassword" placeholder="Contraseña">
                ...
                <div class="row">
                    <div class="col">
                        <div class="form-floating mb-3">
                            <input type="password" class="form-control inputRegistro" id="floatingInputpasswordConf" placeholder="Contraseña">
            ...
            <div class="modal-footer" style="border: none;">
                <div class="row">
                    <div class="col">
                        <button type="button" class="btn botonRegistro">Regístrate ahora</button>
                    </div>
                </div>  
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="row g-6">
            <div class="col-md-4">
                ...
                <br>
                <p>En Gold Capital, te ofrecemos dos planes de inversión que se adaptan a tus necesidades.<br>¡Descubre el plan que mejor se adapte a ti y comienza tu viaje hacia el crecimiento económico hoy mismo</p>
                <br><br>
                    ...
                    <div class="tarjeta">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-9">
                                        <h5 class="card-title">PLAN COMERCIAL INICIAL</h5>
                            ...
                            <br>
                            <button type="button" data-bs-toggle="modal" class="btn btn-articule" data-bs-target="#depositarModal">Abrir cuenta comercial</button>
                    ...
                    <div class="tarjeta">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-9">
                                        <h5 class="card-title">PLAN COMERCIAL PREMIUM</h5>
                                        <h6 class="card-subtitle mb-2 text-body-secondary">OBTENGA SU PRIMERA GANANCIA</h6>
                                    </div>
                                    <div class="col-3">
                                        <img src="img/home/planComercial2.png" alt="">
                                    </div>
                                </div>
                                <p class="card-text">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="32.42" height="25.5" viewBox="0 0 32.42 25.5">
                            ...
                            <div class="select_content">
                                ...
                                <div class="formDepositar seccion_clara">
                                    ...
                                    <div class="mb-3 text-center">
                                        ...
                                        <select id="PlanInversion" class="form-select">
                                            <option selected>Seleccione</option>
                                            <option value="1">Plan Comercial Inicial</option>
                                            <option value="2">Plan Comercial Premium</option>
                                        </select>
                                    </div>
                                    <div class="mb-3 text-center">
                                        <label for="BilleteraInversion" class="form-label">Selección billetera</label>
                                        <select id="BilleteraInversion" class="form-select">
                                            <option selected>Seleccione</option>
                                            <option value="1">Billetera 1</option>
                                            <option value="2">Billetera 2</option>
                                            <option value="3">Billetera 3</option>
                                            <option value="4">Billetera 4</option>
                                        </select>
                                    </div>
                                    <div class="mb-3 text-center">
                                        <label for="CantidadInversion" class="form-label">Cantidad</label>
                                        <div class="input-group mb-3">
                                            <input id="CantidadInversion" type="text" class="form-control">
                            ...
                            <div class="select_content formDepositar seccion_clara">
                                ...
                                <table class="table">
                                    ...
                                    <tr class="text-center">
                                        <th colspan="2">Información requerida</th>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <th>Adjunte comprobante:</th>
                                        <td>support@goldcapitalcompany.com</td>
                                    </tr>
                                </table>
                                <button type="button" class="btn btn-articule" style="margin: auto; display: block">ENVIAR</button>
...
<footer class="seccion_oscura">
    <div class="row">
        <div class="col"><p style="text-align: right;">Gold Capital Company</p></div>
