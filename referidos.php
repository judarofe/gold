...
<head>
    ...
    <title>REFERIDOS | GOLD CAPITAL COMPANY</title>

    <link rel="stylesheet" href="css/home/menu.css">
    <link rel="stylesheet" href="css/referidos/styleReferidos.css">
</head>
<body>
<!-- inicio del menú -->
<header>
...
<section class="seccion_clara">
    <div class="container">
        ...
        <div class="row">
            <div class="col">
                <div class="linkReferido">
                    <p>https://goldcapitalcompany.com/?ref=Shellsy_Franco</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col">
                <div class="contPublicidad">
                    <div class="video"></div>
                    <div class="videoTxt"><p>Video descargable</p></div>
                    <div class="pdf1"></div>
                    <div class="pdf2"></div>
                    <div class="pdfTxt"><p>Pdf presentación</p></div>
                    <div class="flyer1"></div>
                    <div class="flyer2"></div>
                    <div class="flyerTxt"><p>Flyer promocional</p></div>
                </div>
            </div>
        </div>
    </div>
