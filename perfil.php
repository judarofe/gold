...
<head>
    ...
    <title>PERFIL | GOLD CAPITAL COMPANY</title>
</head>
<body>
<!-- inicio del menú -->
<header>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 navbar-centrado">
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="#">Depósitos</a>
                    </li>
                    <li class="nav-item">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-3 text-center">
                                            ...
                                            <input id="NombreCompleto" type="text" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="mb-3 text-center">
                                            <label for="NombreUser" class="form-label">User</label>
                                            <input id="NombreUser" type="text" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <div class="mb-3 text-center">
                                            ...
                                            <input id="ConfirmarCorreo" type="text" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col centrarElementos"><label class="btn btn-articule" for="select_2">SIGUIENTE</label></div>
                                </div>     
                            </div>
                        </div>
                </li>
                        ...
                        <div class="select_content">
                            <div class="formDepositar seccion_clara">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-3 text-center">
                                            <label for="NombreCompleto" class="form-label">Billetera Bitcoin</label>
                                            <input id="NombreCompleto" type="text" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="mb-3 text-center">
                                            <label for="NombreUser" class="form-label">Billetera Ethereum</label>
                                            <input id="NombreUser" type="text" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-3 text-center">
                                            <label for="Direccion" class="form-label">Billetera Litecoin</label>
                                            <input id="Direccion" type="text" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="mb-3 text-center">
                                            <label for="Telefono" class="form-label">Billetera Usdt (TRC20)</label>
                                            <input id="Telefono" type="text" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <div class="mb-3 text-center">
                                            <label for="ConfirmarCorreo" class="form-label">Confirmar Contraseña</label>
                                            <input id="ConfirmarCorreo" type="text" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col centrarElementos">
                                        <label class="btn btn-articule" for="select_3">Actualizar</label>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col">
